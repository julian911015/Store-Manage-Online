...
<div class="art-sheet clearfix">
    ...
    <div id="divTitulo">CREAR PROVEEDORES</div>
    <div id="divAlerta"></div>
    <div id="divLogin">
    <form id="frmAcceso">
    <div id="divLblId">Id: <div id="divTxtId"><?php echo $NroId; ?></div></div>
    <div id="divLblNit"><label for="txtNit">Nit: </label></div>
    <div id="divTxtNit"><input type="text" id="txtNit" name="txtNit" /></div>
    ...
    <div id="divLblDireccion"><label for="txtDireccion">Direccion: </label></div>
    <div id="divTxtDireccion"><input type="text" id="txtDireccion" name="txtDireccion" /></div>
     <div id="divLblTelefono"><label for="txtTelefono">Telefono: </label></div>
    <div id="divTxtTelefono"><input type="text" id="txtTelefono" name="txtTelefono" /></div>
    ...
    <div id="divBtnCrear"><input type="button" id="btnCrearPrv" name="btnCrearPrv" value="Crear"
    onclick='alert("EL PROVEEDOR SE REGISTRÓ SATISFACTORIAMENTE.")'
